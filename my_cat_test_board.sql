...
LOCK TABLES `test_board` WRITE;
/*!40000 ALTER TABLE `test_board` DISABLE KEYS */;
INSERT INTO `test_board` VALUES (2,'테스트제목2','테스트내용2 내용.......2','dog3'),(3,'adfa','adfadf','adfa'),(4,'글 수정','null','테스트'),(6,'','','');
/*!40000 ALTER TABLE `test_board` ENABLE KEYS */;
UNLOCK TABLES;
